...
test.describe('Homepage & Navigation', () => {
  test('Verify Homepage Load', async ({ page }) => {
    ...
    // Expected: Tagline visible
    await expect(page.getByText('Freelance Product Designer, specialised in accessibility and inclusive design.')).toBeVisible();
    ...
    await expect(page.getByText('Read case')).toBeVisible();
  });
});
